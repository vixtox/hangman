...
public class Body extends GridPane{
	...
	public Body() throws FileNotFoundException {
		this.h = getWordFromFile();
	...
	public ImageView getImgHangman() throws FileNotFoundException {
		...
		this.cuadro.setFitHeight(400);
		this.cuadro.setFitWidth(400);
		
		return this.cuadro;
	}

	public Hangman getWordFromFile() {
		Scanner input = new Scanner (System.in);
		Dictionary d = null;
		try {
		d = new Dictionary("animales.txt");
		}
		catch (Exception e) {
